...
export function LessonAccessForm({ initialData, courseId, lessonId }: LessonAccessFormProps) {
        ...
        <div className="mt-6 border bg-slate-100 dark:bg-slate-900 rounded-md p-4">
            ...
            {!isEditing && (
                <p className={cn("text-sm mt-2", !initialData.is_free && "text-slate-500 italic")}>
                    {initialData.is_free ? "This lesson is free for preview." : "This lesson is not free."}
                </p>
            )}
            {isEditing && (
                <Form {...form}>
